...
object DataStoreManager : SettingsStore {
    ...
    private fun Preferences.toAppSettings(): AppSettings = AppSettings(
        ...
        usePrivateStorage = bool("use_private_storage", defaults.usePrivateStorage), safDownloadPath = nullableString("saf_download_path"), downloadDirBookmark = nullableString("download_dir_bookmark"), collapseDownloadedGroup = bool("collapse_downloaded_group", defaults.collapseDownloadedGroup),
