...
val fakeDownloadedVideos = fakeHomePageVideos.take(3).mapIndexed { index, item ->
    VideoWithCategories(
        video = HanimeDownloadEntity(
            ...
            state = io.github.daisukikaffuchino.han1meviewer.logic.state.DownloadState.Finished,
            id = index + 1,
        ),
...
val fakeVideoIntroduction = HanimeVideo(
    ...
    views = "137.6万次",
    videoUrls = io.github.daisukikaffuchino.han1meviewer.HanimeResolution().apply {
